export const DESIGN = {
  appName: 'Mythos',
  tagline: 'Follow the hidden threads between gods, stories and recurring ideas.',
};

export const START_DEITIES = ['Thor', 'Apollo', 'Hermes', 'Yama', 'Indra', 'Zeus', 'Agni', 'Odin'];
...
export const ARCHETYPES = [
  {
    ...
    description: 'A recurring storm-warrior pattern: thunder, violent force, kingship and combat against a cosmic adversary.',
  ...
  },
  {
    ...
    description: 'Divine archers whose distance, disease and healing power make them both feared and invoked.',
  ...
  },
  {
    ...
    description: 'Figures who cross borders that others cannot: life and death, mortal and divine, law and transgression.',
  ...
  },
  {
    ...
    description: 'A linguistic trail through daylight-sky gods and the changing roles inherited from older Indo-European traditions.',
  ...
  },
  {
    ...
    description: 'Fire as messenger, forge and civilising force: sacred flame crossing from ritual into craft.',
  ...
  },
  {
    ...
    description: 'Underworld rulers and psychopomps who receive, judge or guide the dead rather than simply causing death.',
...
export const RELATION_META = {
  linguistic: { label: 'Linguistic inheritance', short: 'name lineage', description: 'A connection grounded primarily in historical linguistics or inherited divine naming.' },
  historical: { label: 'Historical contact / fusion', short: 'historical link', description: 'A relationship shaped by documented contact, identification, reinterpretation or religious transmission.' },
  structural: { label: 'Structural comparison', short: 'shared mythic structure', description: 'A strong comparison in role, story pattern or ritual structure without claiming direct historical identity.' },
  comparative: { label: 'Cross-cultural parallel', short: 'comparative echo', description: 'A useful cross-cultural resemblance that invites comparison but is not evidence of shared origin.' },
  speculative: { label: 'Speculative curiosity', short: 'loose echo', description: 'An intentionally cautious, curiosity-led comparison with limited evidence.' },
  model: { label: 'Model-only thematic echo', short: 'trait echo', description: 'A similarity suggested by the site’s manually weighted traits, not by historical evidence.' },
};
